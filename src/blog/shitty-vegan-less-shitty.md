...
{% image "https://cdn-images-1.medium.com/max/4116/1*CNjRn3Hl6M1T4ppGyAK2HQ.png" %}
...
{% image "https://cdn-images-1.medium.com/max/4112/1*BYQBZNp_JBhi4zqtovcSng.png", "My foolproof rating system." %}
...
{% image "https://cdn-images-1.medium.com/max/7528/1*tPDB9I3Wt3hjCa9haQrfHw.png" %}
...
{% image "https://cdn-images-1.medium.com/max/4040/1*nQmiPWFFmpNB2nDzhGm8RQ.png" %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*v9JZv-MNfGL-H6gU7RMrzg.png" %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*SFAz5vzu9Bgu9LK0N59GPQ.png", "Screenshots from similar apps. Very happy to let others experiment with colour." %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*R42JFB5MU-cexfdbryS1Kg.png" %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*UEjGCdSjiodtKh-78jHxXg.png" %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*2Kla6Zg4cG6t_ajdKDj1Kg.png" %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*gqqyQMd5RByd6QxS8ME8xA.png", "‘You’ve been vegan for 2 days’ is much more human than ‘3 Days — Current Streak’." %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*gKZl-_YTc_sOY6o1kzr6Yw.png", "Ovo-vegetarian? Come on, Jared." %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*Bdyc0pSHHVs6m2Wqpm9SHQ.png", "The different stages of a streak." %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*Z3k8SqO0GnCoAkfhiB3fnA.png" %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*OtqWS2ckNz1Eo8s1ObxEVw.png", "The home screen, with and without the diet log prompt." %}
...
{% image "https://cdn-images-1.medium.com/max/3336/1*9-iZ7R76m9sHSAfuuLCl9w.jpeg" %}
...
{% image "https://cdn-images-1.medium.com/max/6672/1*4OSpJCKFH0s0PcExSEQxKw.png", "Minimising the calendar adds space above the fold for more interesting illustrations." %}
...
{% image "https://cdn-images-1.medium.com/max/2000/1*YtasXqSAvvU-Erwl3FVD2Q.gif", "(Thanks to @alexprime on Figma Community for the loading animation.)" %}
...
{% image "https://cdn-images-1.medium.com/max/2000/1*QfkcKTCir-ZIKNpvsPIfpA.gif" %}
